...
my $dir = "Fall2014_Test";

my $fulldata_name = "Spring2015.xls";
...
my $am_teams = 0;
my $dont_care_teams = 14;
my $pm_teams = 0;
my $players_per_team = 18;
...
open(NewPlayersJersey, ">NewPlayersJersey.list");

for (my $team = 1; $team <= $num_teams; $team++) {
    PrintTeamRoster(STDOUT, $team);
    PrintTeamRoster(TEAMS, $team);
    open (localTeam, ">Team ${team}.csv");
...
sub PrintOverallDesiredStat {
    ...
    #printf $file "Teams: %d\n", $num_teams;
	printf "Total Teams: %d, Players: %d, Team Avg. Level: %0.2f, Level Avg [%d, %d, %d, %d, %d], Age Distribution: [<30: %0.1f, <35: %0.1f, <45: %0.1f, <55: %0.1f, >55: %0.1f, >65: %0.1f]\n",$num_teams, $total_players, ($lvl_sum/$total_players),$levels{1}/$num_teams,$levels{2}/$num_teams,$levels{3}/$num_teams,$levels{4}/$num_teams,$levels{5}/$num_teams,$under_30/$num_teams, $under_35/$num_teams, $under_45/$num_teams, $under_55/$num_teams, $over_55/$num_teams, $over_65/$num_teams;
