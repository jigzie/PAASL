...
#my $fulldata_name = "120910-Summer";
#my $fulldata_name = "E33_B.xls";
my $fulldata_name = "130604-Summer.xls";
#my $fulldata_name = $dir . "/111231-Spring";
...
sub PrintTeamInfo {
    ...
    printf $file "]\tGames: %4.1f\tAge: %4.1f \tu30: %d\tu35: %d\tu45: %d\tu50: %d\tu55: %d\tO55: %d\tO60: %d Goalies: %3.1f  D: %3.1f F: %d\n", (1.0 * $games) / $player_count{$team}, (1.0 * $total_age{$team}) / $player_count{$team}, $under_30, $under_35, $under_45, $under_50, $under_55, $over_55, $over_60, $goalies{$team}, $defenders{$team}, $forwards;
}
