...
sub PrintOverallDesiredStat {
    ...
    #printf $file "Teams: %d\n", $num_teams;
	printf "Total Teams: %d, Players: %d, Avg. Level: %0.2f, Age Distribution: [<30: %0.1f, <35: %0.1f, <45: %0.1f, <55: %0.1f, >55: %0.1f, >65: %0.1f]\n",$num_teams, $total_players, ($lvl_sum/$total_players),$under_30/$num_teams, $under_35/$num_teams, $under_45/$num_teams, $under_55/$num_teams, $over_55/$num_teams, $over_65/$num_teams;
